...
public class MediumAsteroid2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (health < 1)
        {
            ...
            GameObject.Instantiate(smallAsteroid2, spawnPosition1, Quaternion.identity);
            GameObject.Instantiate(smallAsteroid2, spawnPosition2, Quaternion.identity);
